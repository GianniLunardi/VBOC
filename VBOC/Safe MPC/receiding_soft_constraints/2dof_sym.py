...
import time
import torch
from doublependulum_class_vboc import OCPdoublependulumReceidingSoft, SYMdoublependulum, nn_decisionfunction_conservative
...
ocp = OCPdoublependulumReceidingSoft("SQP_RTI", time_step, tot_time, params, mean, std, safety_margin, regenerate)
