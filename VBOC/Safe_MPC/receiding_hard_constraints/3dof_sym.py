...
import time
import torch
from triplependulum_class_vboc import OCPtriplependulumReceidingHard, SYMtriplependulum, nn_decisionfunction_conservative
...
# Save pickle file
data_dir = '../data_3dof/'
with open(data_dir + 'results_receiding_hardsoft.pkl', 'wb') as f:
    all_data = dict()
